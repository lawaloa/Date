...
Download the datasets used for this course below:

[florida_hurricane_dates.pkl](https://github.com/lawaloa/Date/blob/main/datasets/florida_hurricane_dates.pkl){target="_blank"}

[capital-onebike.csv](https://github.com/lawaloa/Date/blob/main/datasets/capital-onebike.csv){target="_blank"}
